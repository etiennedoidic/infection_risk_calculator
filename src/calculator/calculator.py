...
#steady state model
def calc_n_max_ss(exp_time, max_aerol_radius, room_vol, air_exch_rate, mean_ceiling_height_m, ERq, mask): #exp time in hrs
...
#transient model
def calc_n_max_t(exp_time, max_aerol_radius, room_vol, air_exch_rate, mean_ceiling_height_m, ERq,mask): #exp time in hrs
    eff_aerosol_radius = ((0.4 / (1 - 0.4)) ** (1 / 3)) * max_aerosol_radius
    sett_speed_mm = 3 * (eff_aerosol_radius / 5) ** 2 #mm/s
    sett_speed = sett_speed_mm * 60 * 60 / 1000  # m/hr
    viral_deact_rate = 0.3 * 0.4
...
def calc_max_time(n_max, max_aerol_radius, room_vol, air_exch_rate, mean_ceiling_height_m, ERq,mask):
